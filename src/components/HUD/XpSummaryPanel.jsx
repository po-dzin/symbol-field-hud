...
const XpSummaryPanel = () => {
    ...
    return (
        <div className="absolute top-6 left-6 flex flex-col items-start gap-2 pointer-events-auto z-30">
            {/* Panel Container */}
            <div
                className="backdrop-blur-xl p-5 w-48 transition-all duration-300"
                style={{
